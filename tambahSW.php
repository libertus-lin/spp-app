...
<h2>Tambah Data Siswa</h2>
 	...
 	<table class="table">
 		...
 		<tr>
 			<td>Tahun Ajaran</td>
 			<td>
 				<input class="form-control" type="text" name="tahunajaran" value="2022/2023" disabled >
 			</td>
 		</tr>
 		<tr>
 			<td>Biaya</td>
 			<td>
 				<input class="form-control" type="text" name="biaya" value="250000" disabled>
 			</td>
 		</tr>
 		<tr>
 			<td>Jatuh Tempo</td>
 			<td>
 				<input class="form-control" type="text" name="jatuhtempo" value="2023-10-10" disabled>
 			</td>
 		</tr>
 		<tr>
 			<td></td>
