...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2023 at 10:54 PM
...
(6, 'user', '12dea96fec20593566ab75692c9949596833adc9', 'User'),
(9, 'patricia', 'fdd2ebe3fb1c2a29b8d04d985c4f4d0f96c3b3f8', 'Patricia');
...
--
-- Table structure for table `ortu_murid`
--
...
--
-- Dumping data for table `ortu_murid`
--

INSERT INTO `ortu_murid` (`idortu`, `nama_ortu`) VALUES
(1, 'Jairus Salsab'),
(3, 'Rentonius Rudi');
...
(23, '202310001', 'hanggara P A', 'IX A', '2022/2023', 250000),
(24, '202310002', 'Meyki Ardiansyah', 'IX A', '2022/2023', 250000),
(25, '202310003', 'Chandra Wijaya', 'IX A', '2022/2023', 250000),
(26, '202310004', 'Dedi Marlin Hidayat', 'IX A', '2022/2023', 250000),
(27, '202310005', 'Novian Sandi Putra', 'IX A', '2022/2023', 250000),
(28, '202310006', 'Rina Puspita Sari', 'IX A', '2022/2023', 250000),
(29, '202310007', 'Jeki Sanjaka', 'IX A', '2022/2023', 250000),
(30, '202310008', 'Andry Al-febri', 'IX A', '2022/2023', 250000),
(31, '202310009', 'Atang Al-Farizi', 'IX A', '2022/2023', 250000),
(32, '202310010', 'Kurnia Sari', 'IX A', '', 0);
...
(4, 23, '2019-01-10', 'januari  2019', '2305020001', '2023-05-02', 250000, 'LUNAS', 1),
(5, 23, '2019-02-10', 'Februari  2019', '2305020002', '2023-05-02', 250000, 'LUNAS', 1),
(6, 23, '2019-03-10', 'Maret  2019', '2305020003', '2023-05-02', 250000, 'LUNAS', 1),
(7, 23, '2019-04-10', 'April  2019', '2305020004', '2023-05-02', 250000, 'LUNAS', 1),
...
(109, 32, '1970-01-01', 'januari  1970', NULL, NULL, 0, NULL, NULL),
(110, 32, '1970-02-01', 'Februari  1970', NULL, NULL, 0, NULL, NULL),
(111, 32, '1970-03-01', 'Maret  1970', NULL, NULL, 0, NULL, NULL),
(112, 32, '1970-04-01', 'April  1970', NULL, NULL, 0, NULL, NULL),
(113, 32, '1970-05-01', 'Mei  1970', NULL, NULL, 0, NULL, NULL),
(114, 32, '1970-06-01', 'Juni  1970', NULL, NULL, 0, NULL, NULL),
(115, 32, '1970-07-01', 'Juli  1970', NULL, NULL, 0, NULL, NULL),
(116, 32, '1970-08-01', 'Agustus  1970', NULL, NULL, 0, NULL, NULL),
(117, 32, '1970-09-01', 'September  1970', NULL, NULL, 0, NULL, NULL),
(118, 32, '1970-10-01', 'Oktober  1970', NULL, NULL, 0, NULL, NULL),
(119, 32, '1970-11-01', 'November  1970', NULL, NULL, 0, NULL, NULL),
(120, 32, '1970-12-01', 'Desember  1970', NULL, NULL, 0, NULL, NULL);
...
--
-- Indexes for table `ortu_murid`
--
ALTER TABLE `ortu_murid`
...
--
-- AUTO_INCREMENT for table `ortu_murid`
--
ALTER TABLE `ortu_murid`
  MODIFY `idortu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
